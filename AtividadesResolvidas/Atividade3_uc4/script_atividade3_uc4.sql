...
AND p.fabricante='Mundiale' order by p.nome;
...
select * from produtos_por_fabricante where fabricante='Casa & Cia'; 
/***3
...
select * from vendas_produtosPor_cliente where cliente='Mila Osório';